...
public class DocumentosControlador : ControllerBase
{
    ...
    /// <summary>POST /api/documentos/{id}/firmar — aprueba el documento con el usuario autenticado.</summary>
    ...
    /// <summary>DELETE /api/documentos/{id} — elimina un documento.</summary>
    [HttpDelete("{id:int}")]
